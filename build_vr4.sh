...
LOG_FILE="$DIR/build_vr4.log"
PKG="com.Vortex.BrasilVR4"
...
cp "$DIR/Oculus_VR_Player/Builds/final_ VR_evento_oculos.apk" "$DIR/Oculus_VR_Player/Builds/BrasilVR4.apk"
echo "Done"
