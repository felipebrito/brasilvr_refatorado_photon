...
namespace Evereal.VRVideoPlayer
{
  public class MenuEditor : MonoBehaviour
  {
...
#if VRVIDEOPLAYER_AVPROVIDEO || VRVIDEOPLAYER_EASYMOVIETEXTURE
    ...
    [MenuItem("Tools/Evereal/VRVideoPlayer/MediaPlayer/AVPro Video (Selected)")]
#else
    [MenuItem("Tools/Evereal/VRVideoPlayer/MediaPlayer/AVPro Video")]
#endif
